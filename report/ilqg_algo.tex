...
$$
 ...
 \noindent The structure of the proposed algorithm is summarized in the flowchart below.
 
 \begin{figure}[h!]
 	\centering
 	\includegraphics[width=0.7\textwidth]{images/ilqg_flowchart/ilqg.png}
 	\caption{iLQG Flowchart}
 \end{figure}
 
 \subsection{Computational Complexity}
 According to \cite{fridovichkeil2020}, linearization and cost approximation require $O(n^2)$ calculation at each timestep. The coupled Riccati differential equations solution has complexity $O(n^3)$.